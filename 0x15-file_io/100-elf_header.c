 ...
 * @e_ident: A pointer to an array holding the ELF magic no.s
 *
...
/**
 * print_magic - Prints the magic no.s of the ELF's header.
 * @e_ident: A pointer to an array holding ELF magic no.s.
  * Description: Magic nO.s TO BE separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int i;
 ...
 * @e_ident: pointer to array containing the ELF
 */
void print_osabi(unsigned char *e_ident)
{
	printf("  OS/ABI:                            ");
 ...
 * @e_entry: stores the  address of the ELF entry point.
